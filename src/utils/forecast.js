...
const forecast = (latitude, longtitude, callback) => {
    ...
    request({url, json: true}, (error, {body} = {}) => {
        if (error) {
            ...
            callback(undefined, "It is currently " + weather_descriptions[0] + " outside. The Temperature is " + temperature + " degrees and it feels like " + feelslike + " with " + humidity + "% of humidity.");
        }
